...
int main() {
	...
	cout << "Посчитать произведение элементов, меньших 10 - 3" << endl;
...
void multiplication(list* p)
{
	...
	else
	{
		...
		cout << "Произведение элементов, меньших 10 равно = " << umn << endl;
	}
}
